...
services:
    odoo:
        ...
        mem_reservation: ${intLimitMemoryHard}
        labels:
        ...
        {{- if gt .Values.intDomains "2"}}    
            traefik.domain3.frontend.rule: Host:$strTraefikDomains3
        {{- end}}
        {{- if gt .Values.intDomains "3"}}    
            traefik.domain4.frontend.rule: Host:$strTraefikDomains4
        {{- end}}
        {{- if gt .Values.intDomains "4"}}    
            traefik.domain5.frontend.rule: Host:$strTraefikDomains5
        {{- end}}
        {{- else}}
